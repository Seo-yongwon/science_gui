...
class MissionPanoramaNode(Node):
    ...
    def __init__(self) -> None:
        ...
        self.declare_parameter('heading_topic', '/gnss_heading/yaw_deg')
        ...
        self.create_subscription(Float32, heading_topic, self._cb_hdg, SENSOR_QOS)
        self.create_subscription(Bool, heading_valid_topic, self._cb_hdg_v, SENSOR_QOS)
    ...
    def _cb_hdg(self, msg: Float32) -> None:
        self._heading = msg.data

    def _cb_hdg_v(self, msg: Bool) -> None:
    ...
    def _annotate(self, img: np.ndarray) -> np.ndarray:
        ...
        lines.append(f'Hdg:  {heading:.1f} deg ({v_tag})')
